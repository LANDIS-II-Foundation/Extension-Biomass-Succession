...
- [x] Initial community spin-up is now optional.

# Release Notes

- Latest official release: Version 7.3.1 — September 2026
...
- The latest version can be [downloaded from GitHub](https://github.com/LANDIS-II-Foundation/Extension-Biomass-Succession/blob/master/deploy/installer/LANDIS-II-V8%20Biomass%20Succession%207.3.1-setup.exe).
