...
Source: {#BuildDir}\Landis.Extension.Succession.Biomass-v6.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Succession.Biomass-v6.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Biomass Succession 6.1.txt"
