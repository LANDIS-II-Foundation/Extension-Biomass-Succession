...
namespace Landis.Extension.Succession.Biomass
{
        ...
        : TextParser<IInputParameters>
    {
        ...
        protected override IInputParameters Parse()
        {
            ...
            InputVar<string> woodyDebrisFile = new InputVar<string>("WoodDebrisMapFile");
            if (ReadOptionalVar(woodyDebrisFile))
                parameters.WoodyDebrisMap = woodyDebrisFile.Value;
            else
                parameters.WoodyDebrisMap = null;

            InputVar<string> litterFile = new InputVar<string>("LitterMapFile");
            if (ReadOptionalVar(litterFile))
                parameters.LitterMap = litterFile.Value;
            else
                parameters.LitterMap = null;
